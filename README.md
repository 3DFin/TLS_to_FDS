...
* **Adaptive Data-Driven Bulk Density Clamping:** Integrating sample-driven statistical dispersion limits (empirical quantile winsorization and robust MAD estimators) alongside biophysical solid fuel packing ratio constraints ($\beta_{\max} \cdot \rho_{\text{solid}}$) to adaptively scale 2-stage dynamic bulk density bounds to stand-specific structure.
