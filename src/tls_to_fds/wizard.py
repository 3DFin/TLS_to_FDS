    ...
    def __init__(
        ...
        if not html_path.exists():
            ...
            self.browser.setHtml(
                "<h2 style='color:red; font-family:sans-serif; text-align:center; padding:50px;'>Error: mesh_visualizer.html not found.</h2>"
            )
        else:
        ...
        self.btn_apply.setStyleSheet(
            "background-color: #2e7d32; color: white; font-weight: bold; padding: 10px; border-radius: 5px;"
        )
